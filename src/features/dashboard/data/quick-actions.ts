...
export const quickActions: QuickAction[] = [
    ...
    },
    {
        ...
        href: "/text-to-speech?text=Introducing  BrightBean Coffee - the smoothest roast you'll ever taste. Sourced from high-altitude farms, slow-roasted to prefection, and delivered fresh to your door every single week. Wake up to something extraoridinary. Try BrightBean today and get your first bag free.",
    },
    {
    ...
    },
    {
        ...
        gradient: "from-line-400 to-lime-100",
        href: "/text-to-speech?text=Close your eyes and take a deep breath in. Hold it gently... and release. Feel the weight of the day slowly melting away. With each breath, you're sinking deeper into calm. There is nowhere else you need to be. Just here now. Breathe in peace, breathe out tension.",
    },
];