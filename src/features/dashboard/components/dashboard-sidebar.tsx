          ...
          {items.map((item) => (
            <SidebarMenuItem key={item.title}>
              <SidebarMenuButton
                ...
                tooltip={item.title}
                className="h-9 px-3 py-2 text-[13px] tracking-tight
                font-medium border border-transparent data-[active=true]:border-border data-[active=true]:shadow-[0px_1px_1px_0px_rgba(44,54,53,0.03),
                inset_0px_0px_0px_2px_white]"
              >
                {item.url ? (
                  <Link href={item.url}>
                    <item.icon />
...
export function DashboardSidebar() {
  ...
  const othersMenuItems: MenuItem[] = [
    ...
    },
    {
      ...
      url: "mailto:anup17508@gmail.com",
      icon: Headphones,
    },
  ];
              ...
              <UserButton 
                ...
                appearance={{
                   elements: {
                    ...
                    userButtonBox: "flex-row-revese! gap-2!",
